...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">门诊挂号</a>
      <ul>
        <li><a href="<%=path %>/registerFunction/registerAdd.jsp" target="rightFrame">挂号</a></li>
        <li><a href="<%=path %>/registerFunction/queueOfOffice.jsp" target="rightFrame">查询科室排队情况</a></li>
      </ul>
    </li>
