...
public class TabStoreModifyServlet extends HttpServlet {

	private static final long serialVersionUID = 1403383149152101133L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int result = tabStoreService.modifyTabStore(tabletStore);
		if(result > 0){
			String currentPage = request.getParameter("currentPage");
			String sql = "select * from tablet_store order by t_s_id ";
			...
			response.sendRedirect(request.getContextPath()+"/tabRoomFunction/tabStoreModifyFailure.jsp");
		} 
